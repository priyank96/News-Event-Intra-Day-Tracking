...
words={'pact' : 2,'co-develop' : 1,'raise' : 1,'up' : 2,'not' : -1,'restart' : 1,'nod' : 1,'gets' : 1,'get' : 1,'surges' : 1,'ties' :1,'launch' : 1,'rises' : 1,'meets' : 1,'induct' : 1,'trims' : -1,
       ...
       'costs' : -2,'cost':-2,'declines':-1,'zooms':1,'jumps':1,'warning':-1,'soars':1,'down':-1,'fails':-1,'recalls':-1,'doubles':1,'start':1,'launches':1,'sells':1,'exempts':1,'partner':1,'nears':1
       ,'deal':2,'buy':1,'raises':1,'additional':1,'time':2,'jv':2,'forms':1,'consider':1,'declares':1,'dividend':2,'invokes':1,'pacts':1,'conversion':1,'executes':1,'resumes':1,'begins':1,'winning':1,
...
listed=('tata housing','jubilant life','mahindra holidays','thermax','trident','idfc','ceat','jsw steel','spicejet','nestle india','hitachi home','vedanta',
        ...
        'bharat forge','marico','container corporation','pidilite industries','oracle financial services software','motherson sumi','godrej consumer products','maruti','bhel','eicher motors')
